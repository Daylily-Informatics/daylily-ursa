...
def create_app(
    ...
    if customer_manager:
        ...
        # NOTE: Customer workset routes (list, get, create, cancel, retry, archive, delete) moved to daylib/routes/customer_worksets.py
        ...
        # NOTE: Customer workset routes (restore, logs, metrics, snakemake-log) moved to daylib/routes/customer_worksets.py

        # NOTE: Dashboard routes moved to daylib/routes/dashboard.py
        pass  # End of customer_manager block for routes that remain here

    # NOTE: Billing routes moved to daylib/routes/billing.py
