...
def coverage(
    ...
    cmd = [sys.executable, "-m", "pytest", "--cov=daylily_ursa", "--cov-report=term-missing"]
...
def lint(
    ...
    cmd = [sys.executable, "-m", "ruff", "check", "daylily_ursa/", "tests/"]
...
def format_code(
    ...
    cmd = [sys.executable, "-m", "ruff", "format", "daylily_ursa/", "tests/"]
...
def typecheck():
    ...
    cmd = [sys.executable, "-m", "mypy", "daylily_ursa/"]
...
def all_checks():
    ...
    checks = [
        ("Lint", [sys.executable, "-m", "ruff", "check", "daylily_ursa/", "tests/"]),
        ("Format", [sys.executable, "-m", "ruff", "format", "--check", "daylily_ursa/", "tests/"]),
