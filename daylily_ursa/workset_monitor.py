...
class WorksetMonitor:
    ...
    def register_cluster_capacity(
        ...
        from daylily_ursa.workset_scheduler import ClusterCapacity
    ...
    def run_with_concurrent_processor(self) -> None:
        ...
        from daylily_ursa.workset_concurrent_processor import (
    ...
    def _metrics_script_text(self) -> str:
        ...
        try:
            script_path = resources.files("daylily_ursa").joinpath("workset_metrics.py")
    ...
    def _create_cluster(self, work_yaml: Dict[str, object]) -> str:
        ...
        if not cfg_path:
            # Best-effort: support monitor flows that provide these values inline.
